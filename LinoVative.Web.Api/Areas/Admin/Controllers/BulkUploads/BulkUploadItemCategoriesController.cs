...
{
    public class BulkUploadItemCategoriesController : PrivateAPIBaseController
    {
        public BulkUploadItemCategoriesController(IMediator mediator, ILogger<BulkUploadItemCategoriesController> logger) : base(mediator, logger)
        {
