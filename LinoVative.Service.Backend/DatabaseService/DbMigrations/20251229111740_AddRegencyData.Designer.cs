...
namespace LinoVative.Service.Backend.DatabaseService.DbMigrations
{
    ...
    [Migration("20251229111740_AddRegencyData")]
    partial class AddRegencyData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinoVative.Shared.Dto.Sources.Regency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Customers.CustomerAddress", b =>
                {
                    ...
                    b.HasOne("LinoVative.Service.Core.Sources.Province", "Province")
                        .WithMany()
