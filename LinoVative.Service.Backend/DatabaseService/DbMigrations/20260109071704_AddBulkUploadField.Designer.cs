...
namespace LinoVative.Service.Backend.DatabaseService.DbMigrations
{
    ...
    [Migration("20260109071704_AddBulkUploadField")]
    partial class AddBulkUploadField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinoVative.Service.Core.BulkUploads.ItemBulkUpload", b =>
                {
                    ...
                    b.Property<string>("headerColum10")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("headerColum11")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("headerColum12")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("headerColum13")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("headerColum8")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("headerColum9")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Companies.CompanySetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("RequiredCityForCustomerAddress")
                        .HasColumnType("bit");

                    b.Property<bool>("RequiredPostalCodeForCustomerAddress")
                        .HasColumnType("bit");

                    b.Property<bool>("RequiredProvinceForCustomerAddress")
                        .HasColumnType("bit");

                    b.Property<bool>("RequiredRegencyForCustomerAddress")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Customers.CustomerAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Customers.CustomerContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Items.Item", b =>
                {
                    ...
                    b.Property<decimal?>("DefaultMinimumStock")
                        .HasPrecision(8, 4)
                        .HasColumnType("decimal(8,4)");

                    b.Property<decimal?>("DefaultSellServicePercent")
                        .HasPrecision(8, 4)
                        .HasColumnType("decimal(8,4)");

                    b.Property<decimal?>("DefaultSellTaxPercent")
                        .HasPrecision(8, 4)
                        .HasColumnType("decimal(8,4)");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Items.SKUItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("DefaultPurchaseQty")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal?>("MinimumStockQty")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<bool>("SalePriceIncludeTaxAndService")
                        .HasColumnType("bit");

                    b.Property<Guid>("UnitId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("UseOutletSaleTaxAndService")
                        .HasColumnType("bit");

                    b.Property<string>("VarianName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("SKUItems", (string)null);
                });
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Sources.Regency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Regencies", (string)null);
                });

            modelBuilder.Entity("LinoVative.Service.Core.Suppliers.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Suppliers.SupplierContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Companies.CompanySetting", b =>
                {
                    b.HasOne("LinoVative.Service.Core.Companies.Company", null)
                        .WithOne()
                        .HasForeignKey("LinoVative.Service.Core.Companies.CompanySetting", "CompanyId");
                });
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Customers.CustomerAddress", b =>
                {
                    ...
                    b.HasOne("LinoVative.Service.Core.Customers.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LinoVative.Service.Core.Sources.Regency", "Regency")
                        .WithMany()
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Items.ItemPriceType", b =>
                {
                    ...
                    b.HasOne("LinoVative.Service.Core.Items.SKUItem", "SKUItem")
                        .WithMany("PriceTypes")
                        .HasForeignKey("SKUItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PriceType");

                    b.Navigation("SKUItem");
                });
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Sources.Regency", b =>
                {
                    b.HasOne("LinoVative.Service.Core.Sources.Province", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LinoVative.Service.Core.Suppliers.SupplierAddress", b =>
                {
                    b.HasOne("LinoVative.Service.Core.Suppliers.Supplier", "Supplier")
                        .WithMany("Addresses")
