...
namespace LinoVative.Service.Backend.CrudServices.Items.BulkUploads.Download.BlankTemplates.Group
{
    public class GroupCreateTemplateService : ExcelTemplateBase
    {
        private readonly ILangueageService _lang;
        public GroupCreateTemplateService(ILangueageService lang) : base("CreateItemGroupTemplate", lang, "CreateGroup")
        {
            _lang = lang;
        }
        ...
        public override Task FillWorkSheetWithData(IXLWorksheet worksheet)
        {
            ...
            worksheet.Cells("A1").Value = header("ItemGroupName");
